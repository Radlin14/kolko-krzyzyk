...
public class MinMaxAI implements AIStrategy {
    ...
    private Move findBestMove(Board board) throws FieldWithIndexesDoNotExistException {
        List<Move> availableMoves = board.getCoordinatesOfFieldValue(FieldValue.FREE);
